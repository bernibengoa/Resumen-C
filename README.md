...
| Tipo     | Tamaño (aprox) | Descripción                    |
|----------|----------------|--------------------------------|
| `int`    | 4 bytes        | Números enteros                |
| `float`  | 4 bytes        | Números decimales (menos precisión) |
| `double` | 8 bytes        | Números decimales de mayor precisión |
| `char`   | 1 byte         | Caracteres individuales         |
